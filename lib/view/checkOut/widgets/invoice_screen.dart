                        ...
                        children: [
                          ...
                          pw.Text("Quantity: ${item.qty}",
                              style: pw.TextStyle(
                                  fontSize: 14,
                                  color: PdfColor.fromInt(Colors.black.value))),
                          pw.Text("DISC(%): ${item.taxDiscountPercentage}",
                              style: pw.TextStyle(
                                  fontSize: 14,
                                  color: PdfColor.fromInt(Colors.black.value))),
                          pw.Text("TAX(%): ${item.totalDiscount}",
                              style: pw.TextStyle(
                                  fontSize: 14,
                                  color: PdfColor.fromInt(Colors.black.value))),
                          pw.SizedBox(height: 20),
                        ...
                        children: [
                          pw.Text(
                              ...
                              style: pw.TextStyle(
                                  ...
                                  color: PdfColor.fromInt(Colors.black.value))),
                          pw.Text(
                              widget.checkoutdetail.data.tax.toStringAsFixed(0),
                              style: pw.TextStyle(
                                  fontSize: 14,
                                  color: PdfColor.fromInt(Colors.black.value))),
                        ],
                          ...
                          for (var item in orderItems)
                            Column(
                              ...
                              children: [
                                ...
                                //     style: GoogleFonts.poppins(fontSize: 14)),
                                Text("DISC(%): ${item.taxDiscountPercentage}",
                                    style: GoogleFonts.poppins(fontSize: 14)),
                                Text("TAX(%): ${item.totalDiscount}",
                                    style: GoogleFonts.poppins(fontSize: 14)),
